  ...
  const workAreas = [
    {
      ...
      description:
        "Empowering communities through quality education and skill development programs.",
      image:
    ...
    },
    {
      ...
      description:
        "Providing accessible healthcare services to underserved communities across India.",
      image:
    ...
    },
    {
      ...
      description:
        "Breaking barriers and creating opportunities for women's economic independence.",
      image:
    ...
    },
    {
      ...
      description:
        "Safeguarding children's rights and creating safe environments for their growth.",
      image:
    ...
    },
    {
      ...
      description:
        "Transforming rural communities through infrastructure and sustainable development.",
      image:
    ...
    },
    {
      ...
      description:
        "Rapid emergency response and rehabilitation support during crises.",
      image:
    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-gray-900 to-black text-white">
      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden pt-30">
        <div
          ...
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1644822861254-c99d0022ab70?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D')",
          }}
        >
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 text-center">
          ...
          <p className="text-xl md:text-2xl text-gray-200 max-w-4xl mx-auto leading-relaxed mb-12">
            Transforming lives and building communities across India for over 18
            years. We believe every person deserves dignity, opportunity, and
            hope.
          </p>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-12">
            {impactStats.map((stat, index) => (
              <div
                key={index}
                className="bg-white/10 backdrop-blur-xl rounded-2xl p-6 border border-emerald-500/30 hover:scale-105 transition-transform duration-300"
              >
          ...
          <div className="grid lg:grid-cols-2 gap-16">
            ...
            <div className="relative group">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                To empower marginalized communities through comprehensive
                development programs that create lasting positive change in
                education, healthcare, women's empowerment, and sustainable
                livelihoods.
              </p>
            </div>
            ...
            <div className="relative group">
              ...
              <p className="text-lg text-gray-300 leading-relaxed">
                A just and equitable society where every individual has equal
                access to opportunities, resources, and the chance to live with
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Comprehensive programs addressing the root causes of inequality
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Passionate leaders with decades of experience driving positive
              social change.
            </p>
          </div>
      ...
      <section className="py-20 px-6 bg-gradient-to-r from-emerald-900/10 to-cyan-900/10">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-16">
            ...
            <div className="w-20 h-1 bg-gradient-to-r from-emerald-500 to-cyan-500 rounded-full mx-auto mb-8"></div>
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              From humble beginnings to nationwide impact - milestones that
              ...
              <div className="absolute inset-0 bg-gradient-to-r from-black/90 via-black/70 to-black/90 flex items-center justify-center">
                <div className="text-center max-w-4xl px-8">
                  ...
                  <p className="text-2xl text-gray-200">
                    Building bridges between hope and reality since 2006
                  </p>
                </div>
              </div>
            </div>
              ...
              {[
                {
                  year: "2006",
                  title: "Foundation",
                  desc: "Started with 5 volunteers",
                },
                {
                  year: "2012",
                  title: "Healthcare",
                  desc: "Mobile clinics launched",
                },
                {
                  year: "2018",
                  title: "Digital Era",
      ...
      <section className="py-20 px-6 bg-gradient-to-br from-emerald-900/20 to-cyan-900/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-xl text-gray-300 mb-12 leading-relaxed">
            Together, we can create a world where every person has the
      ...
      <Link
        to="/joinus"
        className="bg-gradient-to-r from-emerald-500 to-teal-500 text-white px-10 py-4 rounded-full hover:from-emerald-600 hover:to-teal-600 transition-all transform hover:scale-105 shadow-2xl font-semibold text-lg flex items-center gap-3"
      >
        <Heart className="w-5 h-5" />
        Get Involved
      </Link>
      ...
      <Link
        to="/contact"
        className="bg-white/10 backdrop-blur-xl border border-emerald-500/30 text-white px-10 py-4 rounded-full hover:bg-white/20 transition-all transform hover:scale-105 font-semibold text-lg"
      >
        Contact Us
      </Link>
    </div>
